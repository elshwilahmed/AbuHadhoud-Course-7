/*
    Write a program to fill two 3x3 Matrix with random numbers, then check if they are equal or not
*/
#include <iostream>
#include <bits/stdc++.h>
...
bool AreEqualMatrices(short r, short c, vector<vector<int> > &v1, vector<vector<int> > &v2) {
    int sum1 = SumOf2DMatrix(r, c, v1);
    int sum2 = SumOf2DMatrix(r, c, v2);
    return sum1 == sum2;
}

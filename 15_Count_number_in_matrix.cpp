/*
    Write a program to fill a 3x3 matrix with random numbers, then ask the user for a number to count its occurrences in the matrix
*/
#include <iostream>
#include <bits/stdc++.h>
...
void njr() {
    ...
    int number;
    cout << "Enter The Number To count in matrix: " << flush;
    cin >> number;
    cout << "Number " << number << " count in matrix is: " << CountNumberInMatrix(3, 3, v1, number) << endl;
}
